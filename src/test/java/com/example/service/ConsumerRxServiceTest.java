...
class ConsumerRxServiceTest {
    @Autowired
    private WebClientRxService webClientService;

    private ConsumerRxService consumerService;

    @BeforeEach
    void setUp() {
        consumerService = new ConsumerRxService(webClientService);
    }

    @Test
    @DisplayName("Consume Observable using WebClient")
    ...
    @Test
    @DisplayName("Consume Flowable using WebClient")
    ...
    @DisplayName("Consume Single using WebClient")
    void consumeSingle() {
    ...
    @Test
    // We can use RestTemplate as well, behaves like a normal request-response
    @DisplayName("Consume Maybe using WebClient, with flag true means with data response")
    ...
    @Test
    // We can use RestTemplate as well, behaves like a normal request-response
    @DisplayName("Consume Maybe using WebClient, with flag false means with EMPTY data response")
    ...
    @Test
    // We can use RestTemplate as well, behaves like a normal request-response
    @DisplayName("Consume Completable using WebClient")
